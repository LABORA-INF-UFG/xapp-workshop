...
class XappDeployTest:
    ...
    def __init__(self, thread:bool = True):
        ...
        self.logger = Logger(name="XappDeployTest") # The name is included in each log entry
        self.logger.set_level(Level.DEBUG) # Levels: DEBUG < INFO < WARNING < ERROR
